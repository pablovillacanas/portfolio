...
export default function CV() {
  return (
    <>
      <Head>
        <title>Pablo Domínguez Villacañas — Frontend Lead &amp; Full-Stack Developer</title>
        <meta
          name="description"
      ...
      <main>
        ...
        <section className={styles.hero}>
          ...
          <div className="container">
            ...
            <ScrollReveal variant="rise-lg" delay={140} as="p" className={styles.heroRole}>
              Más de cinco años liderando equipos de frontend y desarrollando producto
              end-to-end para compañías internacionales — desde paneles de datos en
              tiempo real hasta arquitecturas cloud completas.
            </ScrollReveal>
          ...
          <div className="container">
            <div className={styles.aboutGrid}>
              <ScrollReveal variant="rise-lg">
                ...
                <h2>De la psicología al código — y un enfoque que combina ambas cosas.</h2>
                <p style={{ marginTop: "1.5rem" }}>
                  Empecé formándome en psicología antes de pasarme al desarrollo de
                  software, y esa mezcla sigue marcando cómo trabajo: entender primero
                  a quién va a usar lo que construyo — compañeros de equipo, clientes,
                  usuarios finales — y diseñar la solución técnica alrededor de eso.
                </p>
                <p style={{ marginTop: "1rem" }}>
                  Hoy lidero el equipo de frontend en DEUS, donde tomo decisiones sobre
                  arquitectura, estándares de testing y tecnología para proyectos de
                  analítica de datos para una de las mayores compañías energéticas del
                  mundo, en un entorno internacional y multicultural.
                </p>
              </ScrollReveal>
              <ScrollReveal variant="rise-lg" delay={160} className={styles.aboutStats}>
                ...
                <div className={styles.stat}>
                  ...
                  <div className={styles.statLabel}>Certificaciones técnicas</div>
                </div>
                <div className={styles.stat}>
        ...
        <section id="experiencia">
          <div className="container">
            ...
            <h2 style={{ marginBottom: "3rem" }}>
              Un recorrido por equipos donde construir y decidir han ido de la mano.
            </h2>

            <div className={styles.timeline}>
              <ScrollReveal variant="rise-lg" as="div" className={styles.timelineItem}>
                <div className={styles.timelinePeriod}>Mar. 2022 — Presente</div>
                <div>
                  <div className={styles.timelineRole}>
                    <h3>Frontend Team Lead &amp; Full-Stack Developer</h3>
                    <span className={styles.timelineCompany}>DEUS · Remoto</span>
                  </div>
                  <ul>
                    <li>Desarrollo de nuevas funcionalidades de visualización y análisis de datos para una de las mayores compañías energéticas del mundo.</li>
                    <li>Decisiones sobre tecnologías a aplicar y estándares de librerías/testing entre equipos.</li>
                    <li>Uso intensivo de React, Next.js, Tailwind, HTML, CSS y JavaScript.</li>
                    <li>Creación y mantenimiento de APIs con Django.</li>
                    <li>Desarrollo ágil con Microsoft ADO en un entorno dinámico, multicultural e internacional.</li>
                  </ul>
                </div>
              </ScrollReveal>

              <ScrollReveal variant="rise-lg" delay={80} as="div" className={styles.timelineItem}>
                <div className={styles.timelinePeriod}>Oct. 2022 — Presente</div>
                <div>
                  <div className={styles.timelineRole}>
                    <h3>Full-Stack Developer (freelance)</h3>
                    <span className={styles.timelineCompany}>Opseeker · Remoto</span>
                  </div>
                  <ul>
                    <li>Construcción desde cero de un sistema de metaprogramación para crear flujos de chat conversacionales adaptables.</li>
                    <li>Desarrollo de un chat embebible y programable para mejorar la experiencia de usuario y guiar la toma de decisiones en producto.</li>
                    <li>Creación de una webapp con Next.js para gestionar usuarios, workflows, proyectos y activos de la empresa.</li>
                    <li>Integración con servicios de AWS: Lambda, S3, CloudFront, API Gateway y Cognito.</li>
                    <li>Pipelines de CI/CD con GitHub Actions y desarrollo ágil con Jira.</li>
                  </ul>
                </div>
              </ScrollReveal>

              <ScrollReveal variant="rise-lg" delay={160} as="div" className={styles.timelineItem}>
                <div className={styles.timelinePeriod}>Ago. 2019 — Mar. 2022</div>
                <div>
                  <div className={styles.timelineRole}>
                    <h3>Full-Stack Developer</h3>
                    <span className={styles.timelineCompany}>Situm · Santiago de Compostela</span>
                  </div>
                  <ul>
                    <li>Desarrollo de análisis y representación de datos geoespaciales con React y deck.gl.</li>
                    <li>Mantenimiento y desarrollo de microservicios con Spring Boot.</li>
                    <li>Soporte técnico a clientes internacionales con instalaciones on-premise.</li>
                    <li>Metodología ágil con toma de decisiones conjunta en equipo.</li>
                  </ul>
                </div>
              </ScrollReveal>

              <ScrollReveal variant="rise-lg" delay={240} as="div" className={styles.timelineItem}>
                <div className={styles.timelinePeriod}>Sep. 2021 — Mar. 2022</div>
                <div>
                  <div className={styles.timelineRole}>
                    <h3>Profesor particular de programación (freelance)</h3>
                    <span className={styles.timelineCompany}>Santiago de Compostela</span>
                  </div>
                  <ul>
                    <li>Enseñanza de fundamentos de programación a estudiantes de distintos niveles.</li>
                  </ul>
                </div>
              </ScrollReveal>

              <ScrollReveal variant="rise-lg" delay={320} as="div" className={styles.timelineItem}>
                <div className={styles.timelinePeriod}>Mar. 2019 — Jul. 2019</div>
                <div>
                  <div className={styles.timelineRole}>
                    <h3>Web Developer</h3>
                    <span className={styles.timelineCompany}>usheru · Dublín</span>
                  </div>
                  <ul>
                    <li>Creación de una pasarela de pagos.</li>
                    <li>Desarrollo de nuevas funcionalidades con JavaScript vanilla y Spring + PrimeFaces.</li>
                  </ul>
                </div>
              </ScrollReveal>
            </div>
        ...
        <section id="skills">
          <div className="container">
            ...
            <h2 style={{ marginBottom: "3rem" }}>Herramientas y tecnologías con las que trabajo a diario.</h2>
            ...
            <div className={styles.skillsCols}>
              ...
              <ScrollReveal variant="rise-lg" delay={60}>
                ...
                <div className={styles.skillTags}>
                  ...
                  <span className={styles.skillTag}>Gestión de bases de datos</span>
                </div>
              </ScrollReveal>
              <ScrollReveal variant="rise-lg" delay={120}>
                ...
                <div className={styles.skillTags}>
                  ...
                  <span className={styles.skillTag}>CI/CD · GitHub Actions</span>
        ...
        <section id="formacion">
          <div className="container">
            ...
            <h2 style={{ marginBottom: "3rem" }}>Formación técnica y reconocimientos.</h2>
            ...
            <div className={styles.cards} style={{ marginBottom: "2.5rem" }}>
              <ScrollReveal variant="rise-lg" as="div" className={styles.card}>
                ...
                <p>Programación avanzada en Java sobre la plataforma estándar.</p>
              </ScrollReveal>
              <ScrollReveal variant="rise-lg" delay={60} as="div" className={styles.card}>
                <div className={styles.cardMeta}>Certificación · Oracle</div>
                <h3>Oracle Certified Expert, Java EE 6</h3>
                <p>Desarrollo de aplicaciones empresariales con Java EE.</p>
              </ScrollReveal>
              <ScrollReveal variant="rise-lg" delay={120} as="div" className={styles.card}>
              ...
              <ScrollReveal variant="rise-lg" delay={180} as="div" className={styles.card}>
        ...
        <section id="contacto" className={styles.contact}>
          <div className="container">
            ...
            <ScrollReveal variant="rise-lg" delay={120} as="p" className="lede" style={{ marginTop: "1.5rem" }}>
              Disponible para conversar sobre nuevas oportunidades. Puedes escribirme
              directamente o descargar mi CV en PDF.
            </ScrollReveal>
      ...
      <footer className="footer">
        <div className={`container ${styles.footerInner ?? ""}`} style={{ display: "flex", flexWrap: "wrap", gap: "1.5rem", justifyContent: "space-between", width: "100%" }}>
